        ...
        <div className="bg-[#f6f5f0] text-[#004459]">
            ...
            <section className="flex flex-col lg:flex-row gap-8 px-6 lg:px-24 py-16 items-start">
                ...
                <div className="text-center lg:text-left lg:mb-0 px-6 py-4 lg:px-12">
                    ...
                    <p className="text-[#004459] text-lg leading-relaxed mx-auto lg:mx-0 py-4">
                    Itching to get involved and rub elbows with Liz M?  Consider becoming an ambassador at <Link href="/walkfit">
                    Walkfit</Link> or Talkfit.
                    </p>
                </div>
                </div>
            ...
            <section className="px-6 lg:px-24 py-16">
                <h2 className="text-3xl font-bold text-center mb-10">Explore Initiatives</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {[
                { title: 'Walkfit', desc: 'A walking initiative pairing sighted and non-sighted individuals.' },
                { title: 'Talkfit', desc: 'Interactive workshops promoting accessibility and awareness.' },
                { title: 'White Cane Day', desc: 'Description of White Cane Day' },
                { title: 'Vision Advocacy', desc: 'Empowering voices to influence inclusive policy and spaces.' },
                { title: 'Tech for Inclusion', desc: 'Exploring assistive technology that enhances daily life.' },
                { title: 'Youth Voices', desc: 'Programs supporting advocacy and inclusion for young people.' },
                { title: 'People Health Communication', desc: 'Add a description here.' },
                { title: 'Community Spotlights', desc: 'Highlighting efforts that promote access and equality locally.' }
                ].map((item, index) => (
                <div key={index} className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition" data-aos="fade-up" data-aos-delay={index * 100}>
